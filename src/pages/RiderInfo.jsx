      ...
      <div className="md:flex mt-7">
        ...
        <div className="w-full max-w-[588px] md:ml-[102px] pt-3">
          <div className="w-full max-w-96 border h-fit md:h-[174px]">
            <div>
              <p className="text-2xl font-montserrat">License plate: {rider?.plate_number}</p>
              <p className="text-2xl mt-4 font-montserrat">Keke Color: {rider?.color}</p>
            </div>
                ...
                <div key={item.name} className="p-[15px] space-y-1">
                  <div className="flex items-center gap-[10px]">
                    ...
                    <div>
                      ...
                      <p className="text-base text-eco-neutral-prime font-montserrat">{item.email}</p>
                    </div>
                  </div>
                  <p className="text-sm text-eco-neutral-prime font-montserrat">{item.review}</p>
                  <div className="flex items-center justify-between">
                    <button className="text-xs text-eco-neutral-prime border-b border-eco-neutral-ptext-eco-neutral-prime">
                      Show original
                    </button>
                    <p className="text-xs text-eco-neutral-prime">{item.createdAt}</p>
                  </div>
                </div>
              ))}
            </div>
